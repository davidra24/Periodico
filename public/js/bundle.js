...
var _Periodico = __webpack_require__(28);

var _Periodico2 = _interopRequireDefault(_Periodico);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_Periodico2.default, null), document.getElementById('reactApp'));
...
var Periodico = function (_Component) {
    _inherits(Periodico, _Component);

    function Periodico() {
        _classCallCheck(this, Periodico);

        var _this = _possibleConstructorReturn(this, (Periodico.__proto__ || Object.getPrototypeOf(Periodico)).call(this));
    ...
    _createClass(Periodico, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var _this2 = this;

            _superagent2.default.get('http://cocomquickeat.herokuapp.com/obtenercategoria').end(function (err, res) {
                var categorias = JSON.parse(res.text).Categorias;
                _this2.setState({
        ...
        value: function render() {
            var categorias = this.state.categorias.map(function (categoria, i) {
